...
def parse_args():
    ...
    cgroup.add_argument('--l', action='store_true', default=True, 
    ...
    parser.add_argument('--create_list', type=str, default = 'no')
...
if __name__ == '__main__':
    ...
    print ('made it through arg parse')
    
    print ('looking inside of prefix: {}'.format(args.prefix))
    
    if args.create_list == 'Yes':
        
        print ('tripped list creation')
        make_list(args)
    else:
